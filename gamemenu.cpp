...
GameMenu::GameMenu(QWidget *parent) : QWidget(parent)
{
    ...
    m_TicTacToeButton = new QPushButton(tr("TicTacToe"));
    ...
    m_ArcanoidButton = new QPushButton(tr("Arcanoid"));
    ...
    m_SnakeButton = new QPushButton(tr("Snake"));
    ...
    m_BackToMenuButton = new QPushButton(tr("Back"));
